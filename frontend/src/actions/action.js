...
export const LoginCRUD = logState => dispatch => {
  ...
  axios
    .post(`https://africanmarketplace2.herokuapp.com/api/auth/login`, logState)
    .then(res => {
...
export const SignUpCRUD = signState => dispatch => {
  ...
  axios
    .post(
      `https://africanmarketplace2.herokuapp.com/api/auth/register`,
      signState
    )
    .then(res => {
...
export const EditProductCRUD = edit => dispatch => {
  ...
  axios
    .put(`https://africanmarketplace2.herokuapp.com/api/products/:id`, edit)
    .then(res => {
...
export const AddProductCRUD = add => dispatch => {
  ...
  axios
    .post(`https://africanmarketplace2.herokuapp.com/api/products`, add)
    .then(res => {
...
export const DeleteProductCRUD = del => dispatch => {
  ...
  axios
    .delete(`https://africanmarketplace2.herokuapp.com/api/products/:id`, del)
    .then(res => {
